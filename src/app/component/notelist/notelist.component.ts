...
export class NotelistComponent implements OnInit {
  ...
  public openDialog(note): void {
    ...
    dialogRef.afterClosed().subscribe(result => {
      this.noteService.updateNote(note, note.noteId);

    });
  }

  public onCloseUpdateNote(note) {
    this.noteService.updateNote(note, note.noteId).subscribe(resp => {
      this.noteArray = resp;
  ...
  public onArchive(products) {
    ...
    this.noteService.updateNote(products, products.noteId).subscribe(resp => {
      console.log(resp);
    }, (error) => {
      console.log(error);
    })
  ...
  onFileSelected(event, note) {
    ...
    this.noteService.uploadNoteImage(fd, note.noteId).subscribe(resp => {
      console.log(resp);
    }, (error) => {
      console.log(error);
    })
